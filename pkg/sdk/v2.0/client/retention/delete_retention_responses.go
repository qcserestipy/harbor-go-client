...
func (o *DeleteRetentionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeleteRetentionUnauthorized) Error() string {
	...
	return fmt.Sprintf("[DELETE /retentions/{id}][%d] deleteRetentionUnauthorized %s", 401, payload)
}
...
func (o *DeleteRetentionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /retentions/{id}][%d] deleteRetentionForbidden %s", 403, payload)
}
...
func (o *DeleteRetentionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /retentions/{id}][%d] deleteRetentionInternalServerError %s", 500, payload)
}
