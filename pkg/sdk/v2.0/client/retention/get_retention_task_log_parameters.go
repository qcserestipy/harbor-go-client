...
func NewGetRetentionTaskLogParams() *GetRetentionTaskLogParams {
	return NewGetRetentionTaskLogParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetRetentionTaskLogParams].
...
func (o *GetRetentionTaskLogParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param tid
	if err := r.SetPathParam("tid", conv.FormatInteger(o.Tid)); err != nil {
		return err
	}
