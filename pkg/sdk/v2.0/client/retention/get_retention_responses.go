...
func (o *GetRetentionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetRetentionOK) Error() string {
	...
	return fmt.Sprintf("[GET /retentions/{id}][%d] getRetentionOK %s", 200, payload)
}
...
func (o *GetRetentionUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /retentions/{id}][%d] getRetentionUnauthorized %s", 401, payload)
}
...
func (o *GetRetentionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /retentions/{id}][%d] getRetentionForbidden %s", 403, payload)
}
...
func (o *GetRetentionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /retentions/{id}][%d] getRetentionInternalServerError %s", 500, payload)
}
