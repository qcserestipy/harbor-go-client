...
func (a *Client) GetRentenitionMetadata(ctx context.Context, params *GetRentenitionMetadataParams) (*GetRentenitionMetadataOK, error) {
	...
	case *GetRentenitionMetadataOK:
		return value, nil
	case *GetRentenitionMetadataUnauthorized:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	case *GetRentenitionMetadataInternalServerError:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	}
...
type innerParams struct {
	...
	// Deprecated: use the operation call with context to pass the context instead of [RetentionParams].
	ctx context.Context
}
