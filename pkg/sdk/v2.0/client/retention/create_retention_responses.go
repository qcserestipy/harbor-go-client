...
func (o *CreateRetentionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateRetentionBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /retentions][%d] createRetentionBadRequest %s", 400, payload)
}
...
func (o *CreateRetentionUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /retentions][%d] createRetentionUnauthorized %s", 401, payload)
}
...
func (o *CreateRetentionForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /retentions][%d] createRetentionForbidden %s", 403, payload)
}
...
func (o *CreateRetentionInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /retentions][%d] createRetentionInternalServerError %s", 500, payload)
}
