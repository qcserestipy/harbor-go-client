...
func NewUpdateImmuRuleParams() *UpdateImmuRuleParams {
	return NewUpdateImmuRuleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateImmuRuleParams].
