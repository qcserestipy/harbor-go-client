...
func NewListImmuRulesParams() *ListImmuRulesParams {
	return NewListImmuRulesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListImmuRulesParams].
