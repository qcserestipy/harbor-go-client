...
func NewDeleteImmuRuleParams() *DeleteImmuRuleParams {
	return NewDeleteImmuRuleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteImmuRuleParams].
...
func (o *DeleteImmuRuleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if err := r.SetPathParam("immutable_rule_id", conv.FormatInteger(o.ImmutableRuleID)); err != nil {
		return err
	}
