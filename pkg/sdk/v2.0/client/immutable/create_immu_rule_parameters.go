...
func NewCreateImmuRuleParams() *CreateImmuRuleParams {
	return NewCreateImmuRuleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateImmuRuleParams].
