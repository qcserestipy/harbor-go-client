...
func (o *GetScanDataExportExecutionListReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetScanDataExportExecutionListOK) Error() string {
	...
	return fmt.Sprintf("[GET /export/cve/executions][%d] getScanDataExportExecutionListOK %s", 200, payload)
}
...
func (o *GetScanDataExportExecutionListUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/executions][%d] getScanDataExportExecutionListUnauthorized %s", 401, payload)
}
...
func (o *GetScanDataExportExecutionListForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/executions][%d] getScanDataExportExecutionListForbidden %s", 403, payload)
}
...
func (o *GetScanDataExportExecutionListNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/executions][%d] getScanDataExportExecutionListNotFound %s", 404, payload)
}
...
func (o *GetScanDataExportExecutionListInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/executions][%d] getScanDataExportExecutionListInternalServerError %s", 500, payload)
}
