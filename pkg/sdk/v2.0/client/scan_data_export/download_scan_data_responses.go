...
func (o *DownloadScanDataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DownloadScanDataOK) Error() string {
	return fmt.Sprintf("[GET /export/cve/download/{execution_id}][%d] downloadScanDataOK", 200)
}
...
func (o *DownloadScanDataUnauthorized) Error() string {
	...
	return fmt.Sprintf("[GET /export/cve/download/{execution_id}][%d] downloadScanDataUnauthorized %s", 401, payload)
}
...
func (o *DownloadScanDataForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/download/{execution_id}][%d] downloadScanDataForbidden %s", 403, payload)
}
...
func (o *DownloadScanDataNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/download/{execution_id}][%d] downloadScanDataNotFound %s", 404, payload)
}
...
func (o *DownloadScanDataInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /export/cve/download/{execution_id}][%d] downloadScanDataInternalServerError %s", 500, payload)
}
