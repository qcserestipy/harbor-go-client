...
func NewExportScanDataParams() *ExportScanDataParams {
	return NewExportScanDataParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ExportScanDataParams].
