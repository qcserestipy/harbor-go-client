...
func (o *ExportScanDataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ExportScanDataOK) Error() string {
	...
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataOK %s", 200, payload)
}
...
func (o *ExportScanDataBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataBadRequest %s", 400, payload)
}
...
func (o *ExportScanDataUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataUnauthorized %s", 401, payload)
}
...
func (o *ExportScanDataForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataForbidden %s", 403, payload)
}
...
func (o *ExportScanDataNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataNotFound %s", 404, payload)
}
...
func (o *ExportScanDataMethodNotAllowed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataMethodNotAllowed %s", 405, payload)
}
...
func (o *ExportScanDataConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataConflict %s", 409, payload)
}
...
func (o *ExportScanDataInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /export/cve][%d] exportScanDataInternalServerError %s", 500, payload)
}
