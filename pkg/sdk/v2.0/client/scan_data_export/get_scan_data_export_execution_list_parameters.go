...
func NewGetScanDataExportExecutionListParams() *GetScanDataExportExecutionListParams {
	return NewGetScanDataExportExecutionListParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetScanDataExportExecutionListParams].
