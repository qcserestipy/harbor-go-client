...
func NewGetProjectMemberParams() *GetProjectMemberParams {
	return NewGetProjectMemberParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetProjectMemberParams].
