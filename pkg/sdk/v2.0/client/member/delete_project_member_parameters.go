...
func NewDeleteProjectMemberParams() *DeleteProjectMemberParams {
	return NewDeleteProjectMemberParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteProjectMemberParams].
...
func (o *DeleteProjectMemberParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param mid
	if err := r.SetPathParam("mid", conv.FormatInteger(o.Mid)); err != nil {
		return err
	}
