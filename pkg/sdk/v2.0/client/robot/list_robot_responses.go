...
func (o *ListRobotOK) Error() string {
	...
	return fmt.Sprintf("[GET /robots][%d] listRobotOK %s", 200, payload)
}
...
func (o *ListRobotBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /robots][%d] listRobotBadRequest %s", 400, payload)
}
...
func (o *ListRobotNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /robots][%d] listRobotNotFound %s", 404, payload)
}
...
func (o *ListRobotInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /robots][%d] listRobotInternalServerError %s", 500, payload)
}
