...
func (o *RefreshSecOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /robots/{robot_id}][%d] refreshSecOK %s", 200, payload)
}
...
func (o *RefreshSecBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /robots/{robot_id}][%d] refreshSecBadRequest %s", 400, payload)
}
...
func (o *RefreshSecUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /robots/{robot_id}][%d] refreshSecUnauthorized %s", 401, payload)
}
...
func (o *RefreshSecForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /robots/{robot_id}][%d] refreshSecForbidden %s", 403, payload)
}
...
func (o *RefreshSecNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /robots/{robot_id}][%d] refreshSecNotFound %s", 404, payload)
}
...
func (o *RefreshSecInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /robots/{robot_id}][%d] refreshSecInternalServerError %s", 500, payload)
}
