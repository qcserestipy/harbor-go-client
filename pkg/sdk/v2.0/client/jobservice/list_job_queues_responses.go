...
func (o *ListJobQueuesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListJobQueuesOK) Error() string {
	...
	return fmt.Sprintf("[GET /jobservice/queues][%d] listJobQueuesOK %s", 200, payload)
}
...
func (o *ListJobQueuesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/queues][%d] listJobQueuesUnauthorized %s", 401, payload)
}
...
func (o *ListJobQueuesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/queues][%d] listJobQueuesForbidden %s", 403, payload)
}
...
func (o *ListJobQueuesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/queues][%d] listJobQueuesNotFound %s", 404, payload)
}
...
func (o *ListJobQueuesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/queues][%d] listJobQueuesInternalServerError %s", 500, payload)
}
