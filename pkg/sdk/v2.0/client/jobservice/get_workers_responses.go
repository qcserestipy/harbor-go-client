...
func (o *GetWorkersOK) Error() string {
	...
	return fmt.Sprintf("[GET /jobservice/pools/{pool_id}/workers][%d] getWorkersOK %s", 200, payload)
}
...
func (o *GetWorkersUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/pools/{pool_id}/workers][%d] getWorkersUnauthorized %s", 401, payload)
}
...
func (o *GetWorkersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/pools/{pool_id}/workers][%d] getWorkersForbidden %s", 403, payload)
}
...
func (o *GetWorkersNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/pools/{pool_id}/workers][%d] getWorkersNotFound %s", 404, payload)
}
...
func (o *GetWorkersInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /jobservice/pools/{pool_id}/workers][%d] getWorkersInternalServerError %s", 500, payload)
}
