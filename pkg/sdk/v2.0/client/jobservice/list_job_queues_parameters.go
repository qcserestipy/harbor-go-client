...
func NewListJobQueuesParams() *ListJobQueuesParams {
	return NewListJobQueuesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListJobQueuesParams].
