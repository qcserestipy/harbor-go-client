...
func (o *CreateUserGroupBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /usergroups][%d] createUserGroupBadRequest %s", 400, payload)
}
...
func (o *CreateUserGroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /usergroups][%d] createUserGroupUnauthorized %s", 401, payload)
}
...
func (o *CreateUserGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /usergroups][%d] createUserGroupForbidden %s", 403, payload)
}
...
func (o *CreateUserGroupConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /usergroups][%d] createUserGroupConflict %s", 409, payload)
}
...
func (o *CreateUserGroupInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /usergroups][%d] createUserGroupInternalServerError %s", 500, payload)
}
