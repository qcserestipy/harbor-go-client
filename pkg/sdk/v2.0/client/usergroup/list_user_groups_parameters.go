...
func NewListUserGroupsParams() *ListUserGroupsParams {
	return NewListUserGroupsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListUserGroupsParams].
