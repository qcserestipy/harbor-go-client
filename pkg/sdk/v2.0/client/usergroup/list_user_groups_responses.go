...
func (o *ListUserGroupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListUserGroupsOK) Error() string {
	...
	return fmt.Sprintf("[GET /usergroups][%d] listUserGroupsOK %s", 200, payload)
}
...
func (o *ListUserGroupsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups][%d] listUserGroupsUnauthorized %s", 401, payload)
}
...
func (o *ListUserGroupsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups][%d] listUserGroupsForbidden %s", 403, payload)
}
...
func (o *ListUserGroupsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups][%d] listUserGroupsInternalServerError %s", 500, payload)
}
