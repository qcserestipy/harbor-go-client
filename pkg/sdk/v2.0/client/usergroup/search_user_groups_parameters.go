...
func NewSearchUserGroupsParams() *SearchUserGroupsParams {
	return NewSearchUserGroupsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SearchUserGroupsParams].
