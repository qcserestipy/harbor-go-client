...
func (o *GetUserGroupOK) Error() string {
	...
	return fmt.Sprintf("[GET /usergroups/{group_id}][%d] getUserGroupOK %s", 200, payload)
}
...
func (o *GetUserGroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups/{group_id}][%d] getUserGroupBadRequest %s", 400, payload)
}
...
func (o *GetUserGroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups/{group_id}][%d] getUserGroupUnauthorized %s", 401, payload)
}
...
func (o *GetUserGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups/{group_id}][%d] getUserGroupForbidden %s", 403, payload)
}
...
func (o *GetUserGroupNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups/{group_id}][%d] getUserGroupNotFound %s", 404, payload)
}
...
func (o *GetUserGroupInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /usergroups/{group_id}][%d] getUserGroupInternalServerError %s", 500, payload)
}
