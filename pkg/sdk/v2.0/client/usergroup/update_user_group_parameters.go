...
func NewUpdateUserGroupParams() *UpdateUserGroupParams {
	return NewUpdateUserGroupParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateUserGroupParams].
