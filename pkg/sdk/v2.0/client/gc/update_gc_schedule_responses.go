...
func (o *UpdateGCScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdateGCScheduleBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /system/gc/schedule][%d] updateGcScheduleBadRequest %s", 400, payload)
}
...
func (o *UpdateGCScheduleUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/gc/schedule][%d] updateGcScheduleUnauthorized %s", 401, payload)
}
...
func (o *UpdateGCScheduleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/gc/schedule][%d] updateGcScheduleForbidden %s", 403, payload)
}
...
func (o *UpdateGCScheduleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/gc/schedule][%d] updateGcScheduleInternalServerError %s", 500, payload)
}
