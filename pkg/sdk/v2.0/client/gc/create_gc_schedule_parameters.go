...
func NewCreateGCScheduleParams() *CreateGCScheduleParams {
	return NewCreateGCScheduleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateGCScheduleParams].
