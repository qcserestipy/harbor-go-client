...
func (o *StopGCReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StopGCUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /system/gc/{gc_id}][%d] stopGcUnauthorized %s", 401, payload)
}
...
func (o *StopGCForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/gc/{gc_id}][%d] stopGcForbidden %s", 403, payload)
}
...
func (o *StopGCNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/gc/{gc_id}][%d] stopGcNotFound %s", 404, payload)
}
...
func (o *StopGCInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/gc/{gc_id}][%d] stopGcInternalServerError %s", 500, payload)
}
