...
func NewGetGCHistoryParams() *GetGCHistoryParams {
	return NewGetGCHistoryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetGCHistoryParams].
