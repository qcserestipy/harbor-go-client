...
func (o *GetScanAllScheduleOK) Error() string {
	...
	return fmt.Sprintf("[GET /system/scanAll/schedule][%d] getScanAllScheduleOK %s", 200, payload)
}
...
func (o *GetScanAllScheduleUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/scanAll/schedule][%d] getScanAllScheduleUnauthorized %s", 401, payload)
}
...
func (o *GetScanAllScheduleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/scanAll/schedule][%d] getScanAllScheduleForbidden %s", 403, payload)
}
...
func (o *GetScanAllSchedulePreconditionFailed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/scanAll/schedule][%d] getScanAllSchedulePreconditionFailed %s", 412, payload)
}
...
func (o *GetScanAllScheduleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/scanAll/schedule][%d] getScanAllScheduleInternalServerError %s", 500, payload)
}
