...
func (o *GetLatestScanAllMetricsOK) Error() string {
	...
	return fmt.Sprintf("[GET /scans/all/metrics][%d] getLatestScanAllMetricsOK %s", 200, payload)
}
...
func (o *GetLatestScanAllMetricsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scans/all/metrics][%d] getLatestScanAllMetricsUnauthorized %s", 401, payload)
}
...
func (o *GetLatestScanAllMetricsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scans/all/metrics][%d] getLatestScanAllMetricsForbidden %s", 403, payload)
}
...
func (o *GetLatestScanAllMetricsPreconditionFailed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scans/all/metrics][%d] getLatestScanAllMetricsPreconditionFailed %s", 412, payload)
}
...
func (o *GetLatestScanAllMetricsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scans/all/metrics][%d] getLatestScanAllMetricsInternalServerError %s", 500, payload)
}
