...
func NewListAccessoriesParams() *ListAccessoriesParams {
	return NewListAccessoriesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAccessoriesParams].
