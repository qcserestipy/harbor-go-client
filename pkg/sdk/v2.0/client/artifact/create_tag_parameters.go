...
func NewCreateTagParams() *CreateTagParams {
	return NewCreateTagParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateTagParams].
...
func (o *CreateTagParams) WithTag(tag *models.NewTag) *CreateTagParams {
	o.SetTag(tag)
	return o
}

// SetTag adds the tag to the create tag params.
func (o *CreateTagParams) SetTag(tag *models.NewTag) {
	o.Tag = tag
}
