...
func NewListArtifactsParams() *ListArtifactsParams {
	return NewListArtifactsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListArtifactsParams].
