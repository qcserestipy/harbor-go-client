...
func NewCopyArtifactParams() *CopyArtifactParams {
	return NewCopyArtifactParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CopyArtifactParams].
