...
func NewGetVulnerabilitiesAdditionParams() *GetVulnerabilitiesAdditionParams {
	return NewGetVulnerabilitiesAdditionParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetVulnerabilitiesAdditionParams].
