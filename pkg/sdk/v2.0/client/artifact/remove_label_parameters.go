...
func NewRemoveLabelParams() *RemoveLabelParams {
	return NewRemoveLabelParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [RemoveLabelParams].
