...
func (o *PingInstancesBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /p2p/preheat/instances/ping][%d] pingInstancesBadRequest %s", 400, payload)
}
...
func (o *PingInstancesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances/ping][%d] pingInstancesUnauthorized %s", 401, payload)
}
...
func (o *PingInstancesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances/ping][%d] pingInstancesInternalServerError %s", 500, payload)
}
