...
func (o *ListProvidersOK) Error() string {
	...
	return fmt.Sprintf("[GET /p2p/preheat/providers][%d] listProvidersOK %s", 200, payload)
}
...
func (o *ListProvidersBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/providers][%d] listProvidersBadRequest %s", 400, payload)
}
...
func (o *ListProvidersUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/providers][%d] listProvidersUnauthorized %s", 401, payload)
}
...
func (o *ListProvidersForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/providers][%d] listProvidersForbidden %s", 403, payload)
}
...
func (o *ListProvidersNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/providers][%d] listProvidersNotFound %s", 404, payload)
}
...
func (o *ListProvidersInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/providers][%d] listProvidersInternalServerError %s", 500, payload)
}
