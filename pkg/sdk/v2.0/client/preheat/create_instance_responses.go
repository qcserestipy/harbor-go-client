...
func (o *CreateInstanceBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /p2p/preheat/instances][%d] createInstanceBadRequest %s", 400, payload)
}
...
func (o *CreateInstanceUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances][%d] createInstanceUnauthorized %s", 401, payload)
}
...
func (o *CreateInstanceForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances][%d] createInstanceForbidden %s", 403, payload)
}
...
func (o *CreateInstanceNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances][%d] createInstanceNotFound %s", 404, payload)
}
...
func (o *CreateInstanceConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances][%d] createInstanceConflict %s", 409, payload)
}
...
func (o *CreateInstanceInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /p2p/preheat/instances][%d] createInstanceInternalServerError %s", 500, payload)
}
