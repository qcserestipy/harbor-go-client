...
func (o *ListInstancesOK) Error() string {
	...
	return fmt.Sprintf("[GET /p2p/preheat/instances][%d] listInstancesOK %s", 200, payload)
}
...
func (o *ListInstancesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/instances][%d] listInstancesBadRequest %s", 400, payload)
}
...
func (o *ListInstancesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/instances][%d] listInstancesUnauthorized %s", 401, payload)
}
...
func (o *ListInstancesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/instances][%d] listInstancesForbidden %s", 403, payload)
}
...
func (o *ListInstancesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/instances][%d] listInstancesNotFound %s", 404, payload)
}
...
func (o *ListInstancesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /p2p/preheat/instances][%d] listInstancesInternalServerError %s", 500, payload)
}
