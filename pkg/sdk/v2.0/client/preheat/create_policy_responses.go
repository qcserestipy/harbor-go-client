...
func (o *CreatePolicyBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /projects/{project_name}/preheat/policies][%d] createPolicyBadRequest %s", 400, payload)
}
...
func (o *CreatePolicyUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /projects/{project_name}/preheat/policies][%d] createPolicyUnauthorized %s", 401, payload)
}
...
func (o *CreatePolicyForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /projects/{project_name}/preheat/policies][%d] createPolicyForbidden %s", 403, payload)
}
...
func (o *CreatePolicyConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /projects/{project_name}/preheat/policies][%d] createPolicyConflict %s", 409, payload)
}
...
func (o *CreatePolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /projects/{project_name}/preheat/policies][%d] createPolicyInternalServerError %s", 500, payload)
}
