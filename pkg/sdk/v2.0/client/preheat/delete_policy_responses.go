...
func (o *DeletePolicyBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /projects/{project_name}/preheat/policies/{preheat_policy_name}][%d] deletePolicyBadRequest %s", 400, payload)
}
...
func (o *DeletePolicyUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name}/preheat/policies/{preheat_policy_name}][%d] deletePolicyUnauthorized %s", 401, payload)
}
...
func (o *DeletePolicyForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name}/preheat/policies/{preheat_policy_name}][%d] deletePolicyForbidden %s", 403, payload)
}
...
func (o *DeletePolicyNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name}/preheat/policies/{preheat_policy_name}][%d] deletePolicyNotFound %s", 404, payload)
}
...
func (o *DeletePolicyInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name}/preheat/policies/{preheat_policy_name}][%d] deletePolicyInternalServerError %s", 500, payload)
}
