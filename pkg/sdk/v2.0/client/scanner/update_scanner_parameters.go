...
func NewUpdateScannerParams() *UpdateScannerParams {
	return NewUpdateScannerParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateScannerParams].
