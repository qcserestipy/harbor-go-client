...
func NewCreateScannerParams() *CreateScannerParams {
	return NewCreateScannerParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateScannerParams].
