...
func (o *CreateScannerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateScannerBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /scanners][%d] createScannerBadRequest %s", 400, payload)
}
...
func (o *CreateScannerUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /scanners][%d] createScannerUnauthorized %s", 401, payload)
}
...
func (o *CreateScannerForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /scanners][%d] createScannerForbidden %s", 403, payload)
}
...
func (o *CreateScannerInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /scanners][%d] createScannerInternalServerError %s", 500, payload)
}
