...
func (o *UpdateScannerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdateScannerUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /scanners/{registration_id}][%d] updateScannerUnauthorized %s", 401, payload)
}
...
func (o *UpdateScannerForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /scanners/{registration_id}][%d] updateScannerForbidden %s", 403, payload)
}
...
func (o *UpdateScannerNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /scanners/{registration_id}][%d] updateScannerNotFound %s", 404, payload)
}
...
func (o *UpdateScannerInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /scanners/{registration_id}][%d] updateScannerInternalServerError %s", 500, payload)
}
