...
func NewGetScannerMetadataParams() *GetScannerMetadataParams {
	return NewGetScannerMetadataParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetScannerMetadataParams].
