...
func NewDeleteScannerParams() *DeleteScannerParams {
	return NewDeleteScannerParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteScannerParams].
