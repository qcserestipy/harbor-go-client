...
func NewPingScannerParams() *PingScannerParams {
	return NewPingScannerParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PingScannerParams].
