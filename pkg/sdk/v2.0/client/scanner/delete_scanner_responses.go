...
func (o *DeleteScannerReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeleteScannerOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /scanners/{registration_id}][%d] deleteScannerOK %s", 200, payload)
}
...
func (o *DeleteScannerUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /scanners/{registration_id}][%d] deleteScannerUnauthorized %s", 401, payload)
}
...
func (o *DeleteScannerForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /scanners/{registration_id}][%d] deleteScannerForbidden %s", 403, payload)
}
...
func (o *DeleteScannerNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /scanners/{registration_id}][%d] deleteScannerNotFound %s", 404, payload)
}
...
func (o *DeleteScannerInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /scanners/{registration_id}][%d] deleteScannerInternalServerError %s", 500, payload)
}
