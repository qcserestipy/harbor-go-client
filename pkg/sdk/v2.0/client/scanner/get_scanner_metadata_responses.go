...
func (o *GetScannerMetadataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetScannerMetadataOK) Error() string {
	...
	return fmt.Sprintf("[GET /scanners/{registration_id}/metadata][%d] getScannerMetadataOK %s", 200, payload)
}
...
func (o *GetScannerMetadataUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scanners/{registration_id}/metadata][%d] getScannerMetadataUnauthorized %s", 401, payload)
}
...
func (o *GetScannerMetadataForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scanners/{registration_id}/metadata][%d] getScannerMetadataForbidden %s", 403, payload)
}
...
func (o *GetScannerMetadataInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /scanners/{registration_id}/metadata][%d] getScannerMetadataInternalServerError %s", 500, payload)
}
