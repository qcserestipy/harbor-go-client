...
func (o *UpdateQuotaBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /quotas/{id}][%d] updateQuotaBadRequest %s", 400, payload)
}
...
func (o *UpdateQuotaUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /quotas/{id}][%d] updateQuotaUnauthorized %s", 401, payload)
}
...
func (o *UpdateQuotaForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /quotas/{id}][%d] updateQuotaForbidden %s", 403, payload)
}
...
func (o *UpdateQuotaNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /quotas/{id}][%d] updateQuotaNotFound %s", 404, payload)
}
...
func (o *UpdateQuotaInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /quotas/{id}][%d] updateQuotaInternalServerError %s", 500, payload)
}
