...
func (o *GetQuotaOK) Error() string {
	...
	return fmt.Sprintf("[GET /quotas/{id}][%d] getQuotaOK %s", 200, payload)
}
...
func (o *GetQuotaUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/{id}][%d] getQuotaUnauthorized %s", 401, payload)
}
...
func (o *GetQuotaForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/{id}][%d] getQuotaForbidden %s", 403, payload)
}
...
func (o *GetQuotaNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/{id}][%d] getQuotaNotFound %s", 404, payload)
}
...
func (o *GetQuotaInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas/{id}][%d] getQuotaInternalServerError %s", 500, payload)
}
