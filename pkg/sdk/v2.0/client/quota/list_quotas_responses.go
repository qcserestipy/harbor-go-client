...
func (o *ListQuotasOK) Error() string {
	...
	return fmt.Sprintf("[GET /quotas][%d] listQuotasOK %s", 200, payload)
}
...
func (o *ListQuotasUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas][%d] listQuotasUnauthorized %s", 401, payload)
}
...
func (o *ListQuotasForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas][%d] listQuotasForbidden %s", 403, payload)
}
...
func (o *ListQuotasInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /quotas][%d] listQuotasInternalServerError %s", 500, payload)
}
