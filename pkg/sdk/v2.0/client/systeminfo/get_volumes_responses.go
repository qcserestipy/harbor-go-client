...
func (o *GetVolumesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetVolumesOK) Error() string {
	...
	return fmt.Sprintf("[GET /systeminfo/volumes][%d] getVolumesOK %s", 200, payload)
}
...
func (o *GetVolumesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /systeminfo/volumes][%d] getVolumesUnauthorized %s", 401, payload)
}
...
func (o *GetVolumesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /systeminfo/volumes][%d] getVolumesForbidden %s", 403, payload)
}
...
func (o *GetVolumesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /systeminfo/volumes][%d] getVolumesNotFound %s", 404, payload)
}
...
func (o *GetVolumesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /systeminfo/volumes][%d] getVolumesInternalServerError %s", 500, payload)
}
