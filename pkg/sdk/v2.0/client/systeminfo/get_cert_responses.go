...
func (o *GetCertReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetCertOK) Error() string {
	return fmt.Sprintf("[GET /systeminfo/getcert][%d] getCertOK", 200)
}
...
func (o *GetCertInternalServerError) Error() string {
	...
	return fmt.Sprintf("[GET /systeminfo/getcert][%d] getCertInternalServerError %s", 500, payload)
}
