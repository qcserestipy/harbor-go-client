...
func (o *GetStatisticReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetStatisticOK) Error() string {
	...
	return fmt.Sprintf("[GET /statistics][%d] getStatisticOK %s", 200, payload)
}
...
func (o *GetStatisticUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /statistics][%d] getStatisticUnauthorized %s", 401, payload)
}
...
func (o *GetStatisticInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /statistics][%d] getStatisticInternalServerError %s", 500, payload)
}
