...
func NewAddProjectMetadatasParams() *AddProjectMetadatasParams {
	return NewAddProjectMetadatasParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [AddProjectMetadatasParams].
