...
func NewDeleteProjectMetadataParams() *DeleteProjectMetadataParams {
	return NewDeleteProjectMetadataParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteProjectMetadataParams].
