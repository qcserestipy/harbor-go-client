...
func NewUpdateProjectMetadataParams() *UpdateProjectMetadataParams {
	return NewUpdateProjectMetadataParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateProjectMetadataParams].
