...
func NewGetProjectMetadataParams() *GetProjectMetadataParams {
	return NewGetProjectMetadataParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetProjectMetadataParams].
