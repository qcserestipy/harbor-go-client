...
func NewSearchLdapGroupParams() *SearchLdapGroupParams {
	return NewSearchLdapGroupParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SearchLdapGroupParams].
