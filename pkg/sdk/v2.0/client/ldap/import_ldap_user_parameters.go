...
func NewImportLdapUserParams() *ImportLdapUserParams {
	return NewImportLdapUserParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ImportLdapUserParams].
