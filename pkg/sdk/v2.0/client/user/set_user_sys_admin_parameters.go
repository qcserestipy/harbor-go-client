...
func NewSetUserSysAdminParams() *SetUserSysAdminParams {
	return NewSetUserSysAdminParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SetUserSysAdminParams].
