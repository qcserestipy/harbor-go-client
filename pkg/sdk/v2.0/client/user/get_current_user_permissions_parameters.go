...
func NewGetCurrentUserPermissionsParams() *GetCurrentUserPermissionsParams {
	return NewGetCurrentUserPermissionsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetCurrentUserPermissionsParams].
...
func (o *GetCurrentUserPermissionsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Relative != nil {
		...
		qRelative := conv.FormatBool(qrRelative)
		if qRelative != "" {
