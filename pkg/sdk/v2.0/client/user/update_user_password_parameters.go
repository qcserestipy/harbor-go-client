...
func NewUpdateUserPasswordParams() *UpdateUserPasswordParams {
	return NewUpdateUserPasswordParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateUserPasswordParams].
