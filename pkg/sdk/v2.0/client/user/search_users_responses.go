...
func (o *SearchUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SearchUsersOK) Error() string {
	...
	return fmt.Sprintf("[GET /users/search][%d] searchUsersOK %s", 200, payload)
}
...
func (o *SearchUsersUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/search][%d] searchUsersUnauthorized %s", 401, payload)
}
...
func (o *SearchUsersInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/search][%d] searchUsersInternalServerError %s", 500, payload)
}
