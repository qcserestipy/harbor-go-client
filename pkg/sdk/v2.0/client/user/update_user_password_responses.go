...
func (o *UpdateUserPasswordUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /users/{user_id}/password][%d] updateUserPasswordUnauthorized %s", 401, payload)
}
...
func (o *UpdateUserPasswordInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/password][%d] updateUserPasswordInternalServerError %s", 500, payload)
}
