...
func NewSetCliSecretParams() *SetCliSecretParams {
	return NewSetCliSecretParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [SetCliSecretParams].
