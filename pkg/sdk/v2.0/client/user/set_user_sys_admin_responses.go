...
func (o *SetUserSysAdminReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SetUserSysAdminUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /users/{user_id}/sysadmin][%d] setUserSysAdminUnauthorized %s", 401, payload)
}
...
func (o *SetUserSysAdminForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/sysadmin][%d] setUserSysAdminForbidden %s", 403, payload)
}
...
func (o *SetUserSysAdminNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/sysadmin][%d] setUserSysAdminNotFound %s", 404, payload)
}
...
func (o *SetUserSysAdminInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/sysadmin][%d] setUserSysAdminInternalServerError %s", 500, payload)
}
...
func (o *SetUserSysAdminInternalServerError) GetPayload() *models.Errors {
	return o.Payload
}
