...
func (o *SetCliSecretReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SetCliSecretUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /users/{user_id}/cli_secret][%d] setCliSecretUnauthorized %s", 401, payload)
}
...
func (o *SetCliSecretForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/cli_secret][%d] setCliSecretForbidden %s", 403, payload)
}
...
func (o *SetCliSecretNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/cli_secret][%d] setCliSecretNotFound %s", 404, payload)
}
...
func (o *SetCliSecretInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /users/{user_id}/cli_secret][%d] setCliSecretInternalServerError %s", 500, payload)
}
