...
func (o *GetUserOK) Error() string {
	...
	return fmt.Sprintf("[GET /users/{user_id}][%d] getUserOK %s", 200, payload)
}
...
func (o *GetUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user_id}][%d] getUserUnauthorized %s", 401, payload)
}
...
func (o *GetUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user_id}][%d] getUserForbidden %s", 403, payload)
}
...
func (o *GetUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user_id}][%d] getUserNotFound %s", 404, payload)
}
...
func (o *GetUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /users/{user_id}][%d] getUserInternalServerError %s", 500, payload)
}
