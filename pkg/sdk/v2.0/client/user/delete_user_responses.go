...
func (o *DeleteUserUnauthorized) Error() string {
	...
	return fmt.Sprintf("[DELETE /users/{user_id}][%d] deleteUserUnauthorized %s", 401, payload)
}
...
func (o *DeleteUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{user_id}][%d] deleteUserForbidden %s", 403, payload)
}
...
func (o *DeleteUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{user_id}][%d] deleteUserNotFound %s", 404, payload)
}
...
func (o *DeleteUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /users/{user_id}][%d] deleteUserInternalServerError %s", 500, payload)
}
