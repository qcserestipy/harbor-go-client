...
func (o *GetPermissionsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /permissions][%d] getPermissionsUnauthorized %s", 401, payload)
}
...
func (o *GetPermissionsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /permissions][%d] getPermissionsForbidden %s", 403, payload)
}
...
func (o *GetPermissionsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /permissions][%d] getPermissionsNotFound %s", 404, payload)
}
