...
func NewGetReportLogParams() *GetReportLogParams {
	return NewGetReportLogParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetReportLogParams].
