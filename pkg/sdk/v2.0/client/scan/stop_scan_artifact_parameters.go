...
func NewStopScanArtifactParams() *StopScanArtifactParams {
	return NewStopScanArtifactParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [StopScanArtifactParams].
