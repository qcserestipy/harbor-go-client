...
func (o *CreateRegistryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreateRegistryBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /registries][%d] createRegistryBadRequest %s", 400, payload)
}
...
func (o *CreateRegistryUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /registries][%d] createRegistryUnauthorized %s", 401, payload)
}
...
func (o *CreateRegistryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /registries][%d] createRegistryForbidden %s", 403, payload)
}
...
func (o *CreateRegistryConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /registries][%d] createRegistryConflict %s", 409, payload)
}
...
func (o *CreateRegistryInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /registries][%d] createRegistryInternalServerError %s", 500, payload)
}
