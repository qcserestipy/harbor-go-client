...
func NewDeleteRegistryParams() *DeleteRegistryParams {
	return NewDeleteRegistryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteRegistryParams].
