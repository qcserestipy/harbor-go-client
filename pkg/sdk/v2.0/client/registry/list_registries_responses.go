...
func (o *ListRegistriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListRegistriesOK) Error() string {
	...
	return fmt.Sprintf("[GET /registries][%d] listRegistriesOK %s", 200, payload)
}
...
func (o *ListRegistriesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries][%d] listRegistriesUnauthorized %s", 401, payload)
}
...
func (o *ListRegistriesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries][%d] listRegistriesForbidden %s", 403, payload)
}
...
func (o *ListRegistriesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries][%d] listRegistriesInternalServerError %s", 500, payload)
}
