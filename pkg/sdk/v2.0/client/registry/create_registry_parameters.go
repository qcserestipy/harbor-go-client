...
func NewCreateRegistryParams() *CreateRegistryParams {
	return NewCreateRegistryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateRegistryParams].
