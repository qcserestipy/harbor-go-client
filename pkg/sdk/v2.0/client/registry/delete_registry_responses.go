...
func (o *DeleteRegistryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeleteRegistryUnauthorized) Error() string {
	...
	return fmt.Sprintf("[DELETE /registries/{id}][%d] deleteRegistryUnauthorized %s", 401, payload)
}
...
func (o *DeleteRegistryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /registries/{id}][%d] deleteRegistryForbidden %s", 403, payload)
}
...
func (o *DeleteRegistryNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /registries/{id}][%d] deleteRegistryNotFound %s", 404, payload)
}
...
func (o *DeleteRegistryPreconditionFailed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /registries/{id}][%d] deleteRegistryPreconditionFailed %s", 412, payload)
}
...
func (o *DeleteRegistryInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /registries/{id}][%d] deleteRegistryInternalServerError %s", 500, payload)
}
