...
func (o *GetRegistryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetRegistryOK) Error() string {
	...
	return fmt.Sprintf("[GET /registries/{id}][%d] getRegistryOK %s", 200, payload)
}
...
func (o *GetRegistryUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}][%d] getRegistryUnauthorized %s", 401, payload)
}
...
func (o *GetRegistryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}][%d] getRegistryForbidden %s", 403, payload)
}
...
func (o *GetRegistryNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}][%d] getRegistryNotFound %s", 404, payload)
}
...
func (o *GetRegistryInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}][%d] getRegistryInternalServerError %s", 500, payload)
}
