...
func (o *GetRegistryInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetRegistryInfoOK) Error() string {
	...
	return fmt.Sprintf("[GET /registries/{id}/info][%d] getRegistryInfoOK %s", 200, payload)
}
...
func (o *GetRegistryInfoUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}/info][%d] getRegistryInfoUnauthorized %s", 401, payload)
}
...
func (o *GetRegistryInfoForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}/info][%d] getRegistryInfoForbidden %s", 403, payload)
}
...
func (o *GetRegistryInfoNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}/info][%d] getRegistryInfoNotFound %s", 404, payload)
}
...
func (o *GetRegistryInfoInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /registries/{id}/info][%d] getRegistryInfoInternalServerError %s", 500, payload)
}
