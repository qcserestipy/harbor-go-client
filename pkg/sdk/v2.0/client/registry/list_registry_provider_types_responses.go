...
func (o *ListRegistryProviderTypesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListRegistryProviderTypesOK) Error() string {
	...
	return fmt.Sprintf("[GET /replication/adapters][%d] listRegistryProviderTypesOK %s", 200, payload)
}
...
func (o *ListRegistryProviderTypesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/adapters][%d] listRegistryProviderTypesUnauthorized %s", 401, payload)
}
...
func (o *ListRegistryProviderTypesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/adapters][%d] listRegistryProviderTypesForbidden %s", 403, payload)
}
...
func (o *ListRegistryProviderTypesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/adapters][%d] listRegistryProviderTypesInternalServerError %s", 500, payload)
}
