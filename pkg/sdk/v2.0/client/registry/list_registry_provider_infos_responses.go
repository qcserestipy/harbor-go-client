...
func (o *ListRegistryProviderInfosReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListRegistryProviderInfosOK) Error() string {
	...
	return fmt.Sprintf("[GET /replication/adapterinfos][%d] listRegistryProviderInfosOK %s", 200, payload)
}
...
func (o *ListRegistryProviderInfosUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/adapterinfos][%d] listRegistryProviderInfosUnauthorized %s", 401, payload)
}
...
func (o *ListRegistryProviderInfosForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/adapterinfos][%d] listRegistryProviderInfosForbidden %s", 403, payload)
}
...
func (o *ListRegistryProviderInfosInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/adapterinfos][%d] listRegistryProviderInfosInternalServerError %s", 500, payload)
}
