...
func NewCreateReplicationPolicyParams() *CreateReplicationPolicyParams {
	return NewCreateReplicationPolicyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateReplicationPolicyParams].
