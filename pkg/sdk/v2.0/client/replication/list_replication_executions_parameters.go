...
func NewListReplicationExecutionsParams() *ListReplicationExecutionsParams {
	return NewListReplicationExecutionsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListReplicationExecutionsParams].
