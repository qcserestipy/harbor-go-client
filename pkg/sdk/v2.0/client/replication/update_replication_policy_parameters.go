...
func NewUpdateReplicationPolicyParams() *UpdateReplicationPolicyParams {
	return NewUpdateReplicationPolicyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateReplicationPolicyParams].
