...
func (o *ListReplicationTasksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListReplicationTasksOK) Error() string {
	...
	return fmt.Sprintf("[GET /replication/executions/{id}/tasks][%d] listReplicationTasksOK %s", 200, payload)
}
...
func (o *ListReplicationTasksUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/executions/{id}/tasks][%d] listReplicationTasksUnauthorized %s", 401, payload)
}
...
func (o *ListReplicationTasksForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/executions/{id}/tasks][%d] listReplicationTasksForbidden %s", 403, payload)
}
...
func (o *ListReplicationTasksInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /replication/executions/{id}/tasks][%d] listReplicationTasksInternalServerError %s", 500, payload)
}
