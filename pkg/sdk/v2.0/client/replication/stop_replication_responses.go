...
func (o *StopReplicationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StopReplicationUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /replication/executions/{id}][%d] stopReplicationUnauthorized %s", 401, payload)
}
...
func (o *StopReplicationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /replication/executions/{id}][%d] stopReplicationForbidden %s", 403, payload)
}
...
func (o *StopReplicationNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /replication/executions/{id}][%d] stopReplicationNotFound %s", 404, payload)
}
...
func (o *StopReplicationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /replication/executions/{id}][%d] stopReplicationInternalServerError %s", 500, payload)
}
