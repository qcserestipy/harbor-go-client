...
func (o *StartReplicationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StartReplicationBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /replication/executions][%d] startReplicationBadRequest %s", 400, payload)
}
...
func (o *StartReplicationUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/executions][%d] startReplicationUnauthorized %s", 401, payload)
}
...
func (o *StartReplicationForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/executions][%d] startReplicationForbidden %s", 403, payload)
}
...
func (o *StartReplicationInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /replication/executions][%d] startReplicationInternalServerError %s", 500, payload)
}
