...
func NewListReplicationPoliciesParams() *ListReplicationPoliciesParams {
	return NewListReplicationPoliciesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListReplicationPoliciesParams].
