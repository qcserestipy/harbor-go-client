...
func (o *DeleteProjectBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}][%d] deleteProjectBadRequest %s", 400, payload)
}
...
func (o *DeleteProjectForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}][%d] deleteProjectForbidden %s", 403, payload)
}
...
Project not found. No project exists with the specified name or ID.
*/
...
func (o *DeleteProjectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}][%d] deleteProjectNotFound %s", 404, payload)
}
...
Project cannot be deleted. The project still contains repositories or has pending tasks.
*/
...
func (o *DeleteProjectPreconditionFailed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}][%d] deleteProjectPreconditionFailed %s", 412, payload)
}
...
func (o *DeleteProjectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}][%d] deleteProjectInternalServerError %s", 500, payload)
}
