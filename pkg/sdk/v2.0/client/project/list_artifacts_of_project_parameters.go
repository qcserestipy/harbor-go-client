...
func NewListArtifactsOfProjectParams() *ListArtifactsOfProjectParams {
	return NewListArtifactsOfProjectParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListArtifactsOfProjectParams].
...
func (o *ListArtifactsOfProjectParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.LatestInRepository != nil {
		...
		qLatestInRepository := conv.FormatBool(qrLatestInRepository)
	...
	if o.WithAccessory != nil {
		...
		qWithAccessory := conv.FormatBool(qrWithAccessory)
		if qWithAccessory != "" {
	...
	if o.WithImmutableStatus != nil {
		...
		qWithImmutableStatus := conv.FormatBool(qrWithImmutableStatus)
	...
	if o.WithLabel != nil {
		...
		qWithLabel := conv.FormatBool(qrWithLabel)
		if qWithLabel != "" {
	...
	if o.WithSbomOverview != nil {
		...
		qWithSbomOverview := conv.FormatBool(qrWithSbomOverview)
	...
	if o.WithScanOverview != nil {
		...
		qWithScanOverview := conv.FormatBool(qrWithScanOverview)
	...
	if o.WithTag != nil {
		...
		qWithTag := conv.FormatBool(qrWithTag)
		if qWithTag != "" {
