...
func (a *Client) GetLogExts(ctx context.Context, params *GetLogExtsParams) (*GetLogExtsOK, error) {
	...
	case *GetLogExtsOK:
		return value, nil
	case *GetLogExtsBadRequest:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	case *GetLogExtsUnauthorized:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	case *GetLogExtsInternalServerError:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	}
	...
	//
	// safeguard: normally, in the absence of a default response, unknown responses return an error above: so this is a codegen issue.
	msg := fmt.Sprintf("unexpected success response for getLogExts: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ListArtifactsOfProject(ctx context.Context, params *ListArtifactsOfProjectParams) (*ListArtifactsOfProjectOK, error) {
	...
	switch value := result.(type) {
	case *ListArtifactsOfProjectOK:
		return value, nil
	case *ListArtifactsOfProjectBadRequest:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	case *ListArtifactsOfProjectUnauthorized:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	case *ListArtifactsOfProjectForbidden:
		return nil, runtime.NewAPIError("unsuccessful response", value, value.Code())
	...
	//
	// safeguard: normally, in the absence of a default response, unknown responses return an error above: so this is a codegen issue.
	msg := fmt.Sprintf("unexpected success response for listArtifactsOfProject: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
