...
func NewListScannerCandidatesOfProjectParams() *ListScannerCandidatesOfProjectParams {
	return NewListScannerCandidatesOfProjectParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListScannerCandidatesOfProjectParams].
