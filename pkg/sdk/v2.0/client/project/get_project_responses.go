...
func (o *GetProjectOK) Error() string {
	...
	return fmt.Sprintf("[GET /projects/{project_name_or_id}][%d] getProjectOK %s", 200, payload)
}
...
func (o *GetProjectUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name_or_id}][%d] getProjectUnauthorized %s", 401, payload)
}
...
func (o *GetProjectForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name_or_id}][%d] getProjectForbidden %s", 403, payload)
}
...
func (o *GetProjectForbidden) GetPayload() *models.Errors {
	return o.Payload
}
...
func (o *GetProjectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name_or_id}][%d] getProjectNotFound %s", 404, payload)
}
...
func (o *GetProjectNotFound) GetPayload() *models.Errors {
	return o.Payload
}
...
func (o *GetProjectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name_or_id}][%d] getProjectInternalServerError %s", 500, payload)
}
