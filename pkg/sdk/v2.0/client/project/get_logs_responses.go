...
func (o *GetLogsOK) Error() string {
	...
	return fmt.Sprintf("[GET /projects/{project_name}/logs][%d] getLogsOK %s", 200, payload)
}
...
func (o *GetLogsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/logs][%d] getLogsBadRequest %s", 400, payload)
}
...
func (o *GetLogsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/logs][%d] getLogsUnauthorized %s", 401, payload)
}
...
func (o *GetLogsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/logs][%d] getLogsInternalServerError %s", 500, payload)
}
