...
func NewGetProjectDeletableParams() *GetProjectDeletableParams {
	return NewGetProjectDeletableParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetProjectDeletableParams].
