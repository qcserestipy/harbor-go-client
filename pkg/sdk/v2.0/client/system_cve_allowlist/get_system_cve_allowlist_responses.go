...
func (o *GetSystemCVEAllowlistReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetSystemCVEAllowlistOK) Error() string {
	...
	return fmt.Sprintf("[GET /system/CVEAllowlist][%d] getSystemCveAllowlistOK %s", 200, payload)
}
...
func (o *GetSystemCVEAllowlistUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/CVEAllowlist][%d] getSystemCveAllowlistUnauthorized %s", 401, payload)
}
...
func (o *GetSystemCVEAllowlistInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/CVEAllowlist][%d] getSystemCveAllowlistInternalServerError %s", 500, payload)
}
