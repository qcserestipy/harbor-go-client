...
func NewPutSystemCVEAllowlistParams() *PutSystemCVEAllowlistParams {
	return NewPutSystemCVEAllowlistParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [PutSystemCVEAllowlistParams].
