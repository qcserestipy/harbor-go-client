...
func (o *PutSystemCVEAllowlistReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PutSystemCVEAllowlistUnauthorized) Error() string {
	...
	return fmt.Sprintf("[PUT /system/CVEAllowlist][%d] putSystemCveAllowlistUnauthorized %s", 401, payload)
}
...
func (o *PutSystemCVEAllowlistForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/CVEAllowlist][%d] putSystemCveAllowlistForbidden %s", 403, payload)
}
...
func (o *PutSystemCVEAllowlistInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/CVEAllowlist][%d] putSystemCveAllowlistInternalServerError %s", 500, payload)
}
