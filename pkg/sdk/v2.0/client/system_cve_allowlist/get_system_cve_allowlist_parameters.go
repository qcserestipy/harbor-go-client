...
func NewGetSystemCVEAllowlistParams() *GetSystemCVEAllowlistParams {
	return NewGetSystemCVEAllowlistParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetSystemCVEAllowlistParams].
