...
func NewUpdateRepositoryParams() *UpdateRepositoryParams {
	return NewUpdateRepositoryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateRepositoryParams].
