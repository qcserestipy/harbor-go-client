...
func (o *ListAllRepositoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListAllRepositoriesOK) Error() string {
	...
	return fmt.Sprintf("[GET /repositories][%d] listAllRepositoriesOK %s", 200, payload)
}
...
func (o *ListAllRepositoriesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /repositories][%d] listAllRepositoriesBadRequest %s", 400, payload)
}
...
func (o *ListAllRepositoriesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /repositories][%d] listAllRepositoriesInternalServerError %s", 500, payload)
}
