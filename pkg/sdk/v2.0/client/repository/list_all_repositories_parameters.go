...
func NewListAllRepositoriesParams() *ListAllRepositoriesParams {
	return NewListAllRepositoriesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListAllRepositoriesParams].
