...
func (o *ListRepositoriesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListRepositoriesOK) Error() string {
	...
	return fmt.Sprintf("[GET /projects/{project_name}/repositories][%d] listRepositoriesOK %s", 200, payload)
}
...
func (o *ListRepositoriesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/repositories][%d] listRepositoriesBadRequest %s", 400, payload)
}
...
func (o *ListRepositoriesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/repositories][%d] listRepositoriesUnauthorized %s", 401, payload)
}
...
func (o *ListRepositoriesForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/repositories][%d] listRepositoriesForbidden %s", 403, payload)
}
...
func (o *ListRepositoriesNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/repositories][%d] listRepositoriesNotFound %s", 404, payload)
}
...
func (o *ListRepositoriesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /projects/{project_name}/repositories][%d] listRepositoriesInternalServerError %s", 500, payload)
}
