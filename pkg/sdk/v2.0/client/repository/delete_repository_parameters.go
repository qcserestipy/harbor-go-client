...
func NewDeleteRepositoryParams() *DeleteRepositoryParams {
	return NewDeleteRepositoryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteRepositoryParams].
