...
func NewUpdateConfigurationsParams() *UpdateConfigurationsParams {
	return NewUpdateConfigurationsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateConfigurationsParams].
