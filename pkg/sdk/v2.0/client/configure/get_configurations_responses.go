...
func (o *GetConfigurationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetConfigurationsOK) Error() string {
	...
	return fmt.Sprintf("[GET /configurations][%d] getConfigurationsOK %s", 200, payload)
}
