...
func (o *GetInternalconfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetInternalconfigOK) Error() string {
	...
	return fmt.Sprintf("[GET /internalconfig][%d] getInternalconfigOK %s", 200, payload)
}
