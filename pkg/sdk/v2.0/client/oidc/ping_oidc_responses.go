...
func (o *PingOIDCReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 403:
		...
		return nil, result
	case 500:
		result := NewPingOIDCInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *PingOIDCBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /system/oidc/ping][%d] pingOidcBadRequest %s", 400, payload)
}
...
func (o *PingOIDCUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/oidc/ping][%d] pingOidcUnauthorized %s", 401, payload)
}
...
func (o *PingOIDCForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/oidc/ping][%d] pingOidcForbidden %s", 403, payload)
}
...
// NewPingOIDCInternalServerError creates a PingOIDCInternalServerError with default headers values
func NewPingOIDCInternalServerError() *PingOIDCInternalServerError {
	return &PingOIDCInternalServerError{}
}

/*
PingOIDCInternalServerError describes a response with status code 500, with default header values.
...
// IsSuccess returns true when this ping Oidc internal server error response has a 2xx status code
func (o *PingOIDCInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this ping Oidc internal server error response has a 3xx status code
func (o *PingOIDCInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this ping Oidc internal server error response has a 4xx status code
func (o *PingOIDCInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this ping Oidc internal server error response has a 5xx status code
func (o *PingOIDCInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this ping Oidc internal server error response a status code equal to that given
func (o *PingOIDCInternalServerError) IsCode(code int) bool {
	return code == 500
}

// Code gets the status code for the ping Oidc internal server error response
func (o *PingOIDCInternalServerError) Code() int {
	return 500
}

func (o *PingOIDCInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/oidc/ping][%d] pingOidcInternalServerError %s", 500, payload)
}

func (o *PingOIDCInternalServerError) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/oidc/ping][%d] pingOidcInternalServerError %s", 500, payload)
}

func (o *PingOIDCInternalServerError) GetPayload() *models.Errors {
	return o.Payload
}

func (o *PingOIDCInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
