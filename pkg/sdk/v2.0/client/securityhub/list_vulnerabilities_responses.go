...
func (o *ListVulnerabilitiesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListVulnerabilitiesOK) Error() string {
	...
	return fmt.Sprintf("[GET /security/vul][%d] listVulnerabilitiesOK %s", 200, payload)
}
...
func (o *ListVulnerabilitiesBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/vul][%d] listVulnerabilitiesBadRequest %s", 400, payload)
}
...
func (o *ListVulnerabilitiesUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/vul][%d] listVulnerabilitiesUnauthorized %s", 401, payload)
}
...
func (o *ListVulnerabilitiesInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/vul][%d] listVulnerabilitiesInternalServerError %s", 500, payload)
}
