...
func (o *GetSecuritySummaryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetSecuritySummaryOK) Error() string {
	...
	return fmt.Sprintf("[GET /security/summary][%d] getSecuritySummaryOK %s", 200, payload)
}
...
func (o *GetSecuritySummaryUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/summary][%d] getSecuritySummaryUnauthorized %s", 401, payload)
}
...
func (o *GetSecuritySummaryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/summary][%d] getSecuritySummaryForbidden %s", 403, payload)
}
...
func (o *GetSecuritySummaryNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/summary][%d] getSecuritySummaryNotFound %s", 404, payload)
}
...
func (o *GetSecuritySummaryInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /security/summary][%d] getSecuritySummaryInternalServerError %s", 500, payload)
}
