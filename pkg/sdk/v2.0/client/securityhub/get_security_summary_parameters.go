...
func NewGetSecuritySummaryParams() *GetSecuritySummaryParams {
	return NewGetSecuritySummaryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetSecuritySummaryParams].
...
func (o *GetSecuritySummaryParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.WithDangerousArtifact != nil {
		...
		qWithDangerousArtifact := conv.FormatBool(qrWithDangerousArtifact)
	...
	if o.WithDangerousCVE != nil {
		...
		qWithDangerousCVE := conv.FormatBool(qrWithDangerousCVE)
