...
func NewListVulnerabilitiesParams() *ListVulnerabilitiesParams {
	return NewListVulnerabilitiesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListVulnerabilitiesParams].
...
func (o *ListVulnerabilitiesParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.TuneCount != nil {
		...
		qTuneCount := conv.FormatBool(qrTuneCount)
		if qTuneCount != "" {
