...
func (o *GetIconReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetIconOK) Error() string {
	...
	return fmt.Sprintf("[GET /icons/{digest}][%d] getIconOK %s", 200, payload)
}
...
func (o *GetIconBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /icons/{digest}][%d] getIconBadRequest %s", 400, payload)
}
...
func (o *GetIconNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /icons/{digest}][%d] getIconNotFound %s", 404, payload)
}
...
func (o *GetIconInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /icons/{digest}][%d] getIconInternalServerError %s", 500, payload)
}
