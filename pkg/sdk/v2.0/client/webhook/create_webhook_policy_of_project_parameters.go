...
func NewCreateWebhookPolicyOfProjectParams() *CreateWebhookPolicyOfProjectParams {
	return NewCreateWebhookPolicyOfProjectParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateWebhookPolicyOfProjectParams].
