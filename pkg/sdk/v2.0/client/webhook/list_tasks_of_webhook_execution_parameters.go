...
func NewListTasksOfWebhookExecutionParams() *ListTasksOfWebhookExecutionParams {
	return NewListTasksOfWebhookExecutionParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListTasksOfWebhookExecutionParams].
