...
func (o *DeleteWebhookPolicyOfProjectReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeleteWebhookPolicyOfProjectBadRequest) Error() string {
	...
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}][%d] deleteWebhookPolicyOfProjectBadRequest %s", 400, payload)
}
...
func (o *DeleteWebhookPolicyOfProjectUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}][%d] deleteWebhookPolicyOfProjectUnauthorized %s", 401, payload)
}
...
func (o *DeleteWebhookPolicyOfProjectForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}][%d] deleteWebhookPolicyOfProjectForbidden %s", 403, payload)
}
...
func (o *DeleteWebhookPolicyOfProjectNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}][%d] deleteWebhookPolicyOfProjectNotFound %s", 404, payload)
}
...
func (o *DeleteWebhookPolicyOfProjectInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}][%d] deleteWebhookPolicyOfProjectInternalServerError %s", 500, payload)
}
