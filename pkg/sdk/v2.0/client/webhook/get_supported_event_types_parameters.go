...
func NewGetSupportedEventTypesParams() *GetSupportedEventTypesParams {
	return NewGetSupportedEventTypesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetSupportedEventTypesParams].
