...
func NewDeleteWebhookPolicyOfProjectParams() *DeleteWebhookPolicyOfProjectParams {
	return NewDeleteWebhookPolicyOfProjectParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteWebhookPolicyOfProjectParams].
