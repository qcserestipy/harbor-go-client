...
func NewListWebhookPoliciesOfProjectParams() *ListWebhookPoliciesOfProjectParams {
	return NewListWebhookPoliciesOfProjectParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListWebhookPoliciesOfProjectParams].
