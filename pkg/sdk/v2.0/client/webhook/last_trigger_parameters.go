...
func NewLastTriggerParams() *LastTriggerParams {
	return NewLastTriggerParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [LastTriggerParams].
