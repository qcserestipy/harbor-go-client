...
func NewListExecutionsOfWebhookPolicyParams() *ListExecutionsOfWebhookPolicyParams {
	return NewListExecutionsOfWebhookPolicyParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListExecutionsOfWebhookPolicyParams].
