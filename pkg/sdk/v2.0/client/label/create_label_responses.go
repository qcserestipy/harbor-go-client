...
func (o *CreateLabelBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /labels][%d] createLabelBadRequest %s", 400, payload)
}
...
func (o *CreateLabelUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /labels][%d] createLabelUnauthorized %s", 401, payload)
}
...
func (o *CreateLabelConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /labels][%d] createLabelConflict %s", 409, payload)
}
...
func (o *CreateLabelUnsupportedMediaType) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /labels][%d] createLabelUnsupportedMediaType %s", 415, payload)
}
...
func (o *CreateLabelInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /labels][%d] createLabelInternalServerError %s", 500, payload)
}
