...
func NewUpdateLabelParams() *UpdateLabelParams {
	return NewUpdateLabelParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdateLabelParams].
