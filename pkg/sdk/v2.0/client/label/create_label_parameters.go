...
func NewCreateLabelParams() *CreateLabelParams {
	return NewCreateLabelParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreateLabelParams].
