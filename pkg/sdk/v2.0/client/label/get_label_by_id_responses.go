...
func (o *GetLabelByIDOK) Error() string {
	...
	return fmt.Sprintf("[GET /labels/{label_id}][%d] getLabelByIdOK %s", 200, payload)
}
...
func (o *GetLabelByIDUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /labels/{label_id}][%d] getLabelByIdUnauthorized %s", 401, payload)
}
...
func (o *GetLabelByIDNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /labels/{label_id}][%d] getLabelByIdNotFound %s", 404, payload)
}
...
func (o *GetLabelByIDInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /labels/{label_id}][%d] getLabelByIdInternalServerError %s", 500, payload)
}
