...
func (o *ListLabelsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ListLabelsOK) Error() string {
	...
	return fmt.Sprintf("[GET /labels][%d] listLabelsOK %s", 200, payload)
}
...
func (o *ListLabelsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /labels][%d] listLabelsBadRequest %s", 400, payload)
}
...
func (o *ListLabelsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /labels][%d] listLabelsUnauthorized %s", 401, payload)
}
...
func (o *ListLabelsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /labels][%d] listLabelsInternalServerError %s", 500, payload)
}
