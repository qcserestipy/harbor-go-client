...
func NewListWebhookJobsParams() *ListWebhookJobsParams {
	return NewListWebhookJobsParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [ListWebhookJobsParams].
...
func (o *ListWebhookJobsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	qPolicyID := conv.FormatInteger(qrPolicyID)
	if qPolicyID != "" {
...
func (o *ListWebhookJobsParams) bindParamStatus(formats strfmt.Registry) []string {
	...
	statusIS := stringutils.JoinByFormat(statusIC, "")
