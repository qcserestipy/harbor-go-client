...
func NewGetSchedulePausedParams() *GetSchedulePausedParams {
	return NewGetSchedulePausedParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetSchedulePausedParams].
