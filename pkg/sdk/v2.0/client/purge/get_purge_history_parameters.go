...
func NewGetPurgeHistoryParams() *GetPurgeHistoryParams {
	return NewGetPurgeHistoryParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPurgeHistoryParams].
