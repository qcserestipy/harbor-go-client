...
func NewUpdatePurgeScheduleParams() *UpdatePurgeScheduleParams {
	return NewUpdatePurgeScheduleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [UpdatePurgeScheduleParams].
