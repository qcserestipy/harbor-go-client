...
func NewGetPurgeScheduleParams() *GetPurgeScheduleParams {
	return NewGetPurgeScheduleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPurgeScheduleParams].
