...
func (o *GetPurgeJobLogReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPurgeJobLogOK) Error() string {
	...
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}/log][%d] getPurgeJobLogOK %s", 200, payload)
}
...
func (o *GetPurgeJobLogBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}/log][%d] getPurgeJobLogBadRequest %s", 400, payload)
}
...
func (o *GetPurgeJobLogUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}/log][%d] getPurgeJobLogUnauthorized %s", 401, payload)
}
...
func (o *GetPurgeJobLogForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}/log][%d] getPurgeJobLogForbidden %s", 403, payload)
}
...
func (o *GetPurgeJobLogNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}/log][%d] getPurgeJobLogNotFound %s", 404, payload)
}
...
func (o *GetPurgeJobLogInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}/log][%d] getPurgeJobLogInternalServerError %s", 500, payload)
}
