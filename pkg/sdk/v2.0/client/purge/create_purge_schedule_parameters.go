...
func NewCreatePurgeScheduleParams() *CreatePurgeScheduleParams {
	return NewCreatePurgeScheduleParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [CreatePurgeScheduleParams].
