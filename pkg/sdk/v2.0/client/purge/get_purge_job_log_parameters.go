...
func NewGetPurgeJobLogParams() *GetPurgeJobLogParams {
	return NewGetPurgeJobLogParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPurgeJobLogParams].
...
func (o *GetPurgeJobLogParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	// path param purge_id
	if err := r.SetPathParam("purge_id", conv.FormatInteger(o.PurgeID)); err != nil {
		return err
	}
