...
func (o *GetPurgeJobReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPurgeJobOK) Error() string {
	...
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}][%d] getPurgeJobOK %s", 200, payload)
}
...
func (o *GetPurgeJobUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}][%d] getPurgeJobUnauthorized %s", 401, payload)
}
...
func (o *GetPurgeJobForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}][%d] getPurgeJobForbidden %s", 403, payload)
}
...
func (o *GetPurgeJobNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}][%d] getPurgeJobNotFound %s", 404, payload)
}
...
func (o *GetPurgeJobInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit/{purge_id}][%d] getPurgeJobInternalServerError %s", 500, payload)
}
