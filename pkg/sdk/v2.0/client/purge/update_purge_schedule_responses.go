...
func (o *UpdatePurgeScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *UpdatePurgeScheduleBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /system/purgeaudit/schedule][%d] updatePurgeScheduleBadRequest %s", 400, payload)
}
...
func (o *UpdatePurgeScheduleUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/purgeaudit/schedule][%d] updatePurgeScheduleUnauthorized %s", 401, payload)
}
...
func (o *UpdatePurgeScheduleForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/purgeaudit/schedule][%d] updatePurgeScheduleForbidden %s", 403, payload)
}
...
func (o *UpdatePurgeScheduleInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/purgeaudit/schedule][%d] updatePurgeScheduleInternalServerError %s", 500, payload)
}
