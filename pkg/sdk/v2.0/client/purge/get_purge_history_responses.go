...
func (o *GetPurgeHistoryReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPurgeHistoryOK) Error() string {
	...
	return fmt.Sprintf("[GET /system/purgeaudit][%d] getPurgeHistoryOK %s", 200, payload)
}
...
func (o *GetPurgeHistoryUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit][%d] getPurgeHistoryUnauthorized %s", 401, payload)
}
...
func (o *GetPurgeHistoryForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit][%d] getPurgeHistoryForbidden %s", 403, payload)
}
...
func (o *GetPurgeHistoryInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /system/purgeaudit][%d] getPurgeHistoryInternalServerError %s", 500, payload)
}
